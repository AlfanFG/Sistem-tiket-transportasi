        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Input Data bandara</h4>
                </div>
                ...
                <form method="POST" id="insert_form">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="field-2" class="control-label">Bandara ID</label>
                                
                             <input type="text" class="form-control" id="bandara" name="bandara" value="" readonly>
                            </div>  
...
$('#d_bandara').on('click','.sweet-14',function(){
      var nopas = $(this).closest('tr').find('td:eq(1)').text();
    var url = '<?php echo base_url() ?>index.php/Bandara/Delete/'+nopas;
...
$('#edit-data').on('submit',function(event){
        ...
        $('#insert_form').on('submit',function(event){
            ...
            if($('#NamaPas').val() == ""){
                ...
                $.ajax({
                    ...
                    url:"<?php echo base_url() ?>index.php/Bandara/insert",
                    method:"POST",
    ...
    $(document).ready(function(){
     ...
     $('#abbr').blur(function(){
      var abbr = $('#abbr').val();
      var url = "<?php echo base_url()?>index.php/Bandara/KodeBandara/"+abbr;
      $.get(url,function(e){
        $('#bandara').val(e);
        // $('#stasiun1').val(e);
    });
