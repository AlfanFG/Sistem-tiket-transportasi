<?php 
 ...
 ?>
         ...
         <div class="row">
            <div class="col-sm-12">
     <form id="print" action="<?php echo site_url('Report/print_jadwal') ?>">
                   
        <button type="submit" id="print-pengembalian" class="btn btn-info"> <span class="glyphicon glyphicon-print"></span> Print Rute</button>
    </form>           
    <div id="data-jadwal">
  ...
  <?php
     $i = 1;
      foreach ($d_jadwal as $data) {
        echo "<tr>";
        echo "<td>".$i."</td>";
        echo "<td class='kode'>".$data['rute_from']."</td>";
